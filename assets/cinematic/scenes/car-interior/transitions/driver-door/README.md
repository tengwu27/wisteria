...
python scripts/media/render_3d_car_door_walk.py \
  assets/cinematic/scenes/car-interior/transitions/driver-door/sources/car-closeup-day-closed-v1.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/sources/car-closeup-day-interior-v1.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/layers/day/01-background.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/layers/day/00-far-trees-v6.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/masks/car-near-scene-alpha-mask-v4.png \
...
python scripts/media/render_3d_car_door_walk.py \
  ...
  assets/cinematic/scenes/car-interior/transitions/driver-door/sources/car-closeup-night-interior-v1.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/layers/night/01-background.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/layers/night/00-far-trees-v6.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/masks/car-near-scene-alpha-mask-v4.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/masks/car-foreground-alpha-mask-v3.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/masks/car-driver-door-outer-mask-v3.png \
  assets/cinematic/scenes/car-interior/transitions/driver-door/masks/car-driver-door-glazing-mask-v3.png \
