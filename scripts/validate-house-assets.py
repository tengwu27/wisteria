#!/usr/bin/env python3
"""Validate the main-house package geometry contract and write a QA report."""
...
RUNTIME_REPORT = ROOT / "src/assets/images/world/house/v2/validation-report.json"
...
def main() -> int:
    ...
    RUNTIME_REPORT.write_text(payload)
